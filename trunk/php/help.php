...
function fluff_help( $contextual_help, $screen_id, $screen ) {
    ...
    switch($screen->id){
        ...
        case 'media_page_gallery-settings':
			...
			<p>This function accepts 2 parameters:
			<ol>
				<li>the slug of the gallery, same as in the shortcode</li>
				<li>the image size (optional) e.g. thumbnail, medium, large, custom-size</li>
			</ol>
			e.g. fluff_add_my_gallery(\'my-gallery\',\'large\');
            ';
            // add to tabs array
            $tabs[] = $help;
